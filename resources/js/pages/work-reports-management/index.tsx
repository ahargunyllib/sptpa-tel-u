						...
						<div className="overflow-x-auto relative w-full text-sm">
							...
							{staffs.map((staff) => {
								return (
									<details
										key={staff.id}
										className="flex flex-col border-b transition-colors hover:bg-muted/50 group"
									>
										<summary className="flex items-center justify-between w-full">
											<span className="py-3 px-4">{staff.name}</span>
											<div className="flex items-center gap-2 cursor-pointer pr-6 group-open:hidden text-blue-500">
												<PlusSquareIcon className="size-4" />
												Selengkapnya
											</div>
											<div className="hidden items-center gap-2 cursor-pointer pr-6 group-open:flex text-muted-foreground">
															...
															<details key={quarter.quarter}>
																<summary className="flex flex-row items-center border-b">
																	...
																	<div className="flex flex-row items-center justify-end w-1/8">
																		<ChevronDown className="mx-4 size-8 cursor-pointer" />
																	</div>
																</summary>
