            ...
            <Dialog open={isShowPreview} onOpenChange={setIsShowPreview}>
                <DialogContent className="sm:max-w-3xl">
                    ...
                    {(eArchive as File).type.startsWith("image") ? (
                        <img
                            src={
                                (eArchive as File).path
                                    ? (eArchive as File).path.startsWith(
                                          "files"
                                      )
                        ...
                        <p>
                            File preview tidak tersedia untuk tipe:{" "}
                            {(eArchive as File).type}
							<br/>
                            <a className="text-blue-500 underline" target="_blank" rel="noopener noreferrer" href={`/storage/${(eArchive as File).path}`}>
