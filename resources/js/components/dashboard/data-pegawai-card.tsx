    ...
    return (
        <div className="py-5 px-6 bg-white rounded-lg flex flex-col w-full gap-6">
            ...
            <div className="w-full gap-6 flex flex-col xl:flex-row">
                <Avatar className="h-40 w-40 rounded-lg object-cover">
                    <AvatarImage
                        src={
                            user.photo_profile
                                ? user.photo_profile.startsWith(
                                      "profile-photos"
                                  )
                ...
                <div className="flex flex-col gap-2.5 text-xs text-[#090E17]">
                    ...
                    <span>{`Deskripsi kerja sebagai: ${getRoleLabel(
                        user.role
                    )}`}</span>
                    <span>{`Bagian Urusan: ${getDivisionLabel(
                        user.division
                    )}`}</span>
