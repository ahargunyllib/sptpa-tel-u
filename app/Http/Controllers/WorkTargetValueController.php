...
class WorkTargetValueController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('work-targets-management/my-work-targets-detail', [
    ...
    public function update(Request $request, String $id)
    {
        try {
            $validatedData = $request->validate([
                'first_quarter_value' => 'required|numeric|min:0|max:100',
                'second_quarter_value' => 'required|numeric|min:0|max:100',
                'third_quarter_value' => 'required|numeric|min:0|max:100',
                'fourth_quarter_value' => 'required|numeric|min:0|max:100',
                'category' => 'required|string|in:light,medium,heavy',
            ]);
            ...
            return back()->with('success', 'Work target value updated successfully.');
        } catch (\Exception $e) {
